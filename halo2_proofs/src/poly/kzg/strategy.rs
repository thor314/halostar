...
impl<'params, E: MultiMillerLoop + Debug> GuardKZG<'params, E> {
  pub(crate) fn new(msm_accumulator: DualMSM<'params, E>) -> Self { Self { msm_accumulator } }
}
...
impl<'params, E: MultiMillerLoop + Debug> SingleStrategy<'params, E> {
  /// Constructs an empty batch verifier
  pub fn new(params: &'params ParamsKZG<E>) -> Self { SingleStrategy { msm: DualMSM::new(params) } }
}
  ...
  E::G2Affine: SerdeCurveAffine,
{
  ...
  fn new(params: &'params ParamsKZG<E>) -> Self { AccumulatorStrategy::new(params) }
  ...
  fn finalize(self) -> bool { self.msm_accumulator.check() }
}
  ...
  E::G2Affine: SerdeCurveAffine,
{
  ...
  fn new(params: &'params ParamsKZG<E>) -> Self { Self::new(params) }
