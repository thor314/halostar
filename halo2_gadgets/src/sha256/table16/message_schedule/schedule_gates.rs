...
impl<F: PrimeField> ScheduleGate<F> {
  ...
  pub fn s_decompose_3(
    ...
    let decompose_check =
      a + b * F::from(1 << 10) + c * F::from(1 << 17) + d * F::from(1 << 19) + word * (-F::ONE);
  ...
  pub fn s_lower_sigma_0(
    ...
    let check_spread_and_range = Gate::two_bit_spread_and_range(b_lo.clone(), spread_b_lo.clone())
      .chain(Gate::two_bit_spread_and_range(b_hi.clone(), spread_b_hi.clone()))
  ...
  pub fn s_lower_sigma_1(
    ...
    let check_spread_and_range = Gate::two_bit_spread_and_range(b_lo.clone(), spread_b_lo.clone())
      .chain(Gate::two_bit_spread_and_range(b_mid.clone(), spread_b_mid.clone()))
